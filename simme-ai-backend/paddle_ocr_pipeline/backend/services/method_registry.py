METHODS = {
    ...
    "ocr_llm": {
        ...
        "label": "OCR + LLM",
        "short_label": "OCR + LLM",
        "description": "Pipeline híbrido com PaddleOCR e Ollama local para interpretação semântica e normalização do JSON.",
        "implemented": True,
        "category": "multimodal",
    },
    "paddleocr_vl": {
    ...
    "paddleocr_vl_llm": {
        "key": "paddleocr_vl_llm",
        "label": "PaddleOCR-VL + LLM",
        "short_label": "VL + Ollama",
        "description": "Importa os resultados PaddleOCR-VL do Colab e usa um LLM local via Ollama para normalizar campos e tabelas com evidência.",
        "implemented": True,
        "category": "multimodal",
    },
}
